...
class GroqProvider:
    """Use Groq behind Argus's small provider interface."""
    ...
    def __init__(
        ...
        *,
        ...
        if not api_key or not api_key.strip():
            raise ProviderError("A Groq API key is required for the configured provider.")
        ...
        if (
            ...
            raise ProviderError(
                "The Groq credential does not look like a single API key. "
    ...
    def stream_reply(
        ...
        *,
        ...
        try:
            ...
            message = f"Groq request failed ({type(error).__name__})"
            if detail:
